...
class FedPSO(flwr.server.strategy.Strategy):
    ...
    def aggregate_fit(
        ...
        # global_best = self.get_best_params(self.best_client)

        return self.global_best, metrics_aggregated

    def get_best_params(self, client: ClientProxy) -> Parameters:
        # make a fitins object
        fit_ins = flwr.common.FitIns([], {"model": "best"})
        result = client.get_parameters(fit_ins, timeout=10000, group_id=None)
        return result
